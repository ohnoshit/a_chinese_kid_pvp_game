                ...
                if huang == '1':
                    while True:
                        ...
                        if huang == '1':
                            ...
                            if ai_settings.first_player_coins >= 15:
                                if self.first_player_increase_hp < 3:
                                    ai_settings.first_player_coins = ai_settings.first_player_coins - 15
                                    print('玩家 ' + self.first_player_name + ' 还有 ' + str(ai_settings.first_player_coins) + ' 个硬币')
                ...
                if huang == '1':
                    while True:
                        ...
                        if huang == '1':
                            ...
                            if ai_settings.second_player_coins >= 15:
                                if self.second_player_increase_hp < 3:
                                    ai_settings.second_player_coins = ai_settings.second_player_coins - 15
                                    print('玩家 ' + self.second_player_name + ' 还有 ' + str(ai_settings.second_player_coins) + ' 个硬币')
