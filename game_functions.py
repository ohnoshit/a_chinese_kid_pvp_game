...
class Huangame():
        ...
        def shop(self):
            ...
            self.shop_things = {
                '1': ['增加1点血量', '2'],
                '2': ['增加1点攻击', '5'],
                '3': ['一级治疗药水', str(ai_settings.primary_healing_potion_p)],
                '4': ['二级治疗药水', str(ai_settings.secondary_healing_potion_p)],
            ...
            while True:
                ...
                if huang == '1':
                    if ai_settings.first_player_coins >= 20:
                        ai_settings.first_player_coins = ai_settings.first_player_coins - 20
                        print('玩家 ' + self.first_player_name + ' 还有 ' + str(ai_settings.first_player_coins) + ' 个硬币')
                        ai_settings.first_player_hp = ai_settings.first_player_hp + 10
